...
os.chdir(r'C:\Users\cassp\OneDrive\Documents\Kovac Lab\Biomarkers paper\SNP hits\Covars 8_14_23')
dfOutput.to_csv(f"{gene}_logreg_8_14_23.csv")
data.to_csv(f"{gene}_snps_8_14_23.csv")
